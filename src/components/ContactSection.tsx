...
//                       }}
//                       className="w-full bg-gradient-to-r from-dark-blue-600 to-light-blue-600 text-white font-semibold py-3 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
//                     >
...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // allow React to re-render UI before async tasks
    ...
    try {
      ...
      await fetch(
        "https://azhizen-academy-elegance-portal.onrender.com/api/get-in-touch",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
